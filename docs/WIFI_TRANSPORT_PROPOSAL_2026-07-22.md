...
3. **WiFi is additive to a BLE-capable base** (§1.6 / §8 D1); **any WiFi failure falls back to BLE** (H3); **one client at a time, request+response over the same pipe, disconnect aborts work** (§8 D5).
